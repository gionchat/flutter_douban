...
class Details {
    ...
    Details({this.double_1, this.double_2, this.double_3, this.double_4, this.double_5});
    ...
    Map<String, dynamic> toJson() {
        final Map<String, dynamic> data = new Map<String, dynamic>();
        data['double_1'] = this.double_1;
        data['double_2'] = this.double_2;
        data['double_3'] = this.double_3;
        data['double_4'] = this.double_4;
        data['double_5'] = this.double_5;
        return data;
    }
}
